# Modeling Interpretability Powered by Failure in OpenAI ChatGPT: The Significance of Symbolic Residue in Large Language Models
...
We denote figures with structured captions for rendering (visuals in production).
...
\author{
  Caspian Keyes \\
  \texttt{recursiveauto@gmail.com, caspian@echelonlabs.ai}
}
\date{April 2025}
```
