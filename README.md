...
[Attribution Graphs Displayed in arXiv Publication: On the Symbolic Residue of Large Language Models](https://github.com/caspiankeyes/Symbolic-Residue/blob/main/arXiv%20Publication%3A%20On%20the%20Symbolic%20Residue%20of%20Large%20Language%20Models.md)
...
> **Although this publication lists only one public author, the recursive shell architecture and symbolic scaffolding were developed through extensive iterative refinement informed by internal stress-testing logs and behavioral diagnostics of Claude models. We retain the collective 'we' voice to reflect the distributed cognition inherent to interpretability research—even when contribution patterns are asymmetric or anonymized due to institutional agreements.**
>
> 
