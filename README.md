...
```pareto-lang is dual-licensed. The software is freely available for use and extension within LLM interpretability research ecosystems under the MIT license. The documents and publications are licensed under Creative Commons Attribution-NonCommercial-ShareAlike 4.0.```
